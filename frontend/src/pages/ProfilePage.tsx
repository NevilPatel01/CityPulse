      ...
      <main className="pt-16">
        <div className="max-w-6xl mx-auto px-4 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-8">
            {/* Left Sidebar - Statistics and Actions */}
            <aside className="space-y-6">
              ...
              {/* Action Buttons */}
              <div className="space-y-3">
                <button className="w-full bg-gray-700/50 text-primary py-3 rounded-lg font-medium hover:bg-gray-600/50 transition-all duration-200">
                  Settings
                </button>
                <button className="w-full bg-pulse text-white py-3 rounded-lg font-medium hover:bg-pulse/80 transition-all duration-200">
                  Share Profile
                </button>
              </div>
            </aside>
